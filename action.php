...
if(isset($_GET["id_favorite"]) && !empty($_GET["id_favorite"]) && is_numeric($_GET["id_favorite"]) && isset($_GET["id_user"])){
    ...
    if(empty($_GET["id_user"]) || !is_numeric($_GET["id_user"])){
        echo '<title>Ulubione</title><style>@import url("https://fonts.googleapis.com/css2?family=Lato:wght@300&display=swap"); body {background-color: #B1DCD3; font-family: "Lato", sans-serif; color: white} h1{font-size: 10em} h3{font-size: 2em} #error{margin: auto; display: flex; flex-direction: column; align-items: center;}</style><div id="error"><h1>Ups...</h1>';
    ...
    echo '<title>Ulubione</title><style>@import url("https://fonts.googleapis.com/css2?family=Lato:wght@300&display=swap"); body {background-color: #B1DCD3; font-family: "Lato", sans-serif; color: white} h1{font-size: 10em} h3{font-size: 2em} #error{margin: auto; display: flex; flex-direction: column; align-items: center;}</style><div id="error"><h1>Ulubione</h1>';
